...
🌌 Developed a document verification system for universities. Every admission cycle, all official transcripts are manually mailed so as to prevent Forgery.

🌌 This is very costly and all the more time-consuming.

🌌 Built a blockchain-powered tamper-proof platform to enable instant transfer of academic records with 100% forgery-proof architecture.

🌌 Curated smart contracts with solidity and deployed on the ethereum main-net. Developed the UI in React.js and linked it with blockchain using Web3.js.
